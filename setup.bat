...
# Run Theme Installer
powershell.exe -Command "Start-Process powershell.exe -ArgumentList '-noprofile', '-executionpolicy', 'Bypass', '-File', 'C:\Windows\Resources\Themes\SawTheme\Setup\SawTheme.ps1' -Verb RunAs"
