# Download Theme
powershell.exe -Command "Start-BitsTransfer -Source 'https://github.com/V0lk3n/SawTheme/releases/download/Pre-Release/SawTheme.zip' -Destination 'C:\Users\$env:UserName\Desktop\SawTheme.zip'"
