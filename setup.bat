...
# Extract Theme
powershell.exe -Command "Start-Process powershell.exe -ArgumentList '-Command', 'Expand-Archive C:\Users\$env:UserName\Desktop\SawTheme.zip C:\Windows\Resources\Themes' -Verb RunAs"
